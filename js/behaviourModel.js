...
let sensors = [
    // {"id": 0, type: "EDGE", probs:[0.2, 0.8], actions:[actions.extend, actions.move]},
...
let moveRate = 1;   // from 1 to 10, speed up and slow down movement (making move function steps longer/shorter)
